...
SAP.common.defineNS("SAP.CR.Events.SetEnableDrillDown", function(enable) {
    var e = SAP.CR.Events.BaseEvent();
    e.addArgument("setEnableDrillDown", enable);

    return e;
});

SAP.common.defineNS("SAP.CR.Events.SetToolPanelViewMode", function(viewMode) {
    var e = SAP.CR.Events.BaseEvent();
    e.addArgument("setToolPanelViewMode", viewMode);

    return e;
});

SAP.common.defineNS("SAP.CR.Events.SetHasToggleGroupTreeButton", function(hasButton) {
    var e = SAP.CR.Events.BaseEvent();
    e.addArgument("setHasToggleGroupTreeButton", hasButton);

    return e;
});

SAP.common.defineNS("SAP.CR.Events.SetHasToggleParameterPanelButton", function(hasButton) {
    var e = SAP.CR.Events.BaseEvent();
    e.addArgument("setHasToggleParameterPanelButton", hasButton);

    return e;
});

SAP.common.defineNS("SAP.CR.Events.SetHasSearchButton", function(hasButton) {
    var e = SAP.CR.Events.BaseEvent();
    e.addArgument("setHasSearchButton", hasButton);

    return e;
});

SAP.common.defineNS("SAP.CR.Events.SetFreezePanesSize", function(width, height) {
    var e = SAP.CR.Events.BaseEvent();
    e.addArgument("setFreezePanesSize", {"freezePanesWidth":width, "freezePanesHeight":height});
