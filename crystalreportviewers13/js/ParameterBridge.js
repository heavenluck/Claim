...
bobj.crv.params.ParameterBridge = {
    ...
    */
    createDomObj: function(viewerName, divID, servletURL, showMinUI, locale, rptSrcKey, isRTL, isInitializing, promptingType, viewerType) {
        this._isRTL = isRTL;
        ...
        if (promptingType == 'flex') {
            ...
            sap.ui.getCore().attachInit(function() {
                var loadPrompt = function() {
                    ...
                    var dialog = new ui5prompting.views.PromptDialog(domId, {
                        adaptor: cb,
