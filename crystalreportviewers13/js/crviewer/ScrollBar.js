...
bobj.crv.HorizontalScrollBar = function() {
    ...
    this._scrollBtnCBIntervalID = null;
    this._scrollableElement = null;
    this._secondaryScrollableElement = null;
...
bobj.crv.HorizontalScrollBar.prototype = {
    ...
    setSecondaryScrollableElement : function(element) {
        this._secondaryScrollableElement = element;
    },
    ...
    _onThumbMoveListener : function(newX, moveByCode) {
        if (this._scrollableElement) {
            ...
            if(elmtW > sbarW) {
                ...
                if (this._secondaryScrollableElement)
                    this._secondaryScrollableElement.style.left = -newLeft + 'px';
