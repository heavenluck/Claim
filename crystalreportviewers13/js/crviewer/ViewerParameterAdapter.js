...
/*
 ...
 Viewer's implementaion for next gen prompting UI
 ================================================================================
 */
...
bobj.crv.params.ViewerParameterAdapter = {
    ...
    /**
     * Callback to start moving the dialog
     */
    ...
    /**
     * Callback when finished moving the dialog
     */
    ...
    /**
     * Callback for moving the dialog.
        ...
        if ((fValue.value !== undefined && fValue.value !== null)){
            ...
            if (path !== undefined && path !== null)
            {
                ...
                for (var i = 0, len = path.length; i < len; i++) {
                    jsValue.anncestors.push(this._convertValue(path[i], type, -1));
                }
            }
            ...
            switch (type) {
                ...
                case Type.TIME:
                case Type.DATE_TIME:
                    jsValue.value = this._convertDateTimeValue(fValue.value, type);
                    break;
                default:
    ...
    setVisibility : function(id) {
        ...
        if (obj) {
            ...
            //TODO: Need to abstract this for UI5
