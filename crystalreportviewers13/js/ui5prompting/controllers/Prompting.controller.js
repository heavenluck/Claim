...
sap.ui.controller("ui5prompting.controllers.Prompting", {
    ...
    bridge: bobj.crv.params.ParameterBridge,
    ...
    closeDialog: function () {
        ...
        this.bridge.closeDialog(this.viewerName);
    },
    ...
    run: function () {
        ...
        if (result) {
            this.bridge.setParamValues(this.viewerName, this.aPromptUnitValues);
        }
        return result;
    }
