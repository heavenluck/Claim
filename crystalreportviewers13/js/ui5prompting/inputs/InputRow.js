...
sap.m.FlexBox.extend("DiscreteInput", {
    ...
    constructor: function(oSettings) {
        ...
        this.oInput = CreateInput(oSettings);
        ...
        oSettings.items = [this.oInput, this.oAddButton];
...
sap.m.MultiInput.extend("MultiInput", {
    ...
    constructor: function(oSettings) {
        ...
        var sValidationPath = {
            path: ModelPathBuilder.BuildFullViewPath(ModelPathBuilder.VIEW_VALIDATION, oSettings.promptData, oSettings.viewerName),
...
sap.m.FlexBox.extend("RangeInput", {
    ...
    constructor: function(oSettings) {
        ...
        oSettings.items = [this.oStartInput, this.oStartArrow, this.oRangeIcon, this.oEndInput, this.oEndArrow, this.oAddButton];
        oSettings.width = "calc(100% - 2rem)";
        oSettings.renderType = sap.m.FlexRendertype.Bare;
        sap.m.FlexBox.call(this, oSettings);
    },
    ...
    attachAddAction: function(addAction) {
        ...
        this.oAddButton.setVisible(true);
        this.setWidth("100%");
        this.oStartInput.setWidth("calc(50% - 4.5rem)");
        this.oEndInput.setWidth("calc(50% - 4.5rem)");
    },
...
sap.m.FlexBox.extend("ConditionRangeInput", {
    ...
    updateInput: function(conditionValue) {
        ...
        if (isBetween) {
            ...
            rangeInput.getPartInput(START_PART).setWidth("50%");
            rangeInput.getPartInput(END_PART).setWidth("50%");
            rangeInput.getPartInput(END_PART).addStyleClass("sapUiSmallMarginBegin");
        } else {
            rangeInput.getPartInput(START_PART).setPlaceholder(sap.ui.getCore().getModel("ui5ResourceBundle").getText("hintDiscrete"));
            rangeInput.getPartInput(START_PART).setWidth("100%");
